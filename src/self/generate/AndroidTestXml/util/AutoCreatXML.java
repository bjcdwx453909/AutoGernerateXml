package transsion.generate.AndroidTestXml.util;
...
/**
 * Created by dxg on 16/12/23.
 */
public class AutoCreatXML {
...
String methodsname ="c";
    ...
    public static AutoCreatXML instance;


    public synchronized static AutoCreatXML getInstance() {
        if (instance == null) {
            instance = new AutoCreatXML();
        }
        return instance;
    }

    //
    public String readFile(File[] files, String testngxmlpath) {
        ...
        String xmlFileName = "AndroidTest.xml";
        String outtpath =   xmlFileName;
